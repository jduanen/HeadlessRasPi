...
The display of information is triggered by a script (i.e., scripts/90wifi-state-change.sh)
that is called by the NetworkManager on WiFi subsystem state changes.
